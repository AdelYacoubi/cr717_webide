jQuery.sap.declare("dcode_completed.Component");
jQuery.sap.require("sap.m.routing.RouteMatchedHandler");

sap.ui.core.UIComponent.extend("dcode_completed.Component", {
	metadata : {
		...
		routing: {
			config: {
				viewType : "XML",
				viewPath: "dcode_completed.view",  // common prefix
	...
	init : function() {
		...
		var rootPath = jQuery.sap.getModulePath("dcode_completed");
	...
	createContent : function() {
		...
		return sap.ui.view({
			viewName : "dcode_completed.view.App",
